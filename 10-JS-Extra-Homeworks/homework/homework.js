...
function deObjetoAmatriz(objeto){
  ...
  let objetoAString = Object.entries(objeto);
...
function asAmirror(str) {
  ...
  for(var i = str.length - 1; i >= 0; i--){
    strInvertido = strInvertido + str[i];
  }
   strInvertido = strInvertido.split(" ");
   for(var i = strInvertido.length - 1; i >= 0; i--){
     array.push(strInvertido[i])
   }
   return array.join(" ")
} 
